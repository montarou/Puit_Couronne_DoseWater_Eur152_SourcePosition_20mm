...
/// @brief Construction du détecteur "puits couronne" - VERSION SANS FILTRE
///
/// Géométrie :
/// - Source Eu-152 à z = 73.5 mm (20 mm avant PMMA)
/// - PAS DE FILTRE (gammas directs sur le container)
/// - Container cylindrique W/PETG ouvert à z = 10 cm
/// - Tranche PMMA (10 mm) avant l'eau (build-up électronique)
...
private:
    ...
    // ═══════════════════════════════════════════════════════════════
    // PARAMÈTRES DE LA TRANCHE PMMA (BUILD-UP)
    // ═══════════════════════════════════════════════════════════════
